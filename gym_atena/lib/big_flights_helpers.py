...
from gym_atena.data_schemas.big_flights.columns_data import (KEYS, KEYS_ANALYST_STR, FILTER_COLS, GROUP_COLS,
...
def create_datasets_repository():
    ...
    datasets_path = path.join(par_dir, 'big_flights/raw_datasets')
...
def create_big_flights_env_properties():
    env_dataset_prop = EnvDatasetProp(
        ...
        DONT_FILTER_FIELDS,
        snorkel_data_obj=SnorkelBigFlightsDataObj,
        snorkel_gen_model=SnorkelGenModel,
        snorkel_training_path="snorkel_dataset_big_flights.jsonl",
    )
