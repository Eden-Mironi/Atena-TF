...
from gym_atena.data_schemas.wide_flights.columns_data import (KEYS, KEYS_ANALYST_STR, FILTER_COLS, GROUP_COLS,
                                                              NUMERIC_KEYS, AGG_KEYS, AGG_KEYS_ANALYST_STR, FILTER_LIST,
                                                              FILTER_BY_FIELD_DICT, DONT_FILTER_FIELDS)
        ...
        for f in self.file_list:
            ...
            df = pd.read_csv(path, sep='\t', index_col=0,
                             dtype={
                                 ...
                                 'departure_delay': 'category',
                                 'scheduled_trip_time': 'category',
                                 'scheduled_departure': 'category',
                                 'scheduled_arrival': 'category',
                                 ...
                                 'year': 'category',
                                 'month': 'category',
                                 'elapsed_time': 'category',
                                 'air_time': 'category',
                                 'distance': 'category',
                                 'air_system_delay': 'category',
                                 'security_delay': 'category',
                                 'airline_delay': 'category',
                                 'late_aircraft_delay': 'category',
                                 'weather_delay': 'category',
                                 'flight_id_2': 'uint32',
                                 'airline_2': 'category',
                                 'origin_airport_2': 'category',
                                 'destination_airport_2': 'category',
                                 'flight_number_2': 'category',
                                 'delay_reason_2': 'category',
                                 'departure_delay_2': 'category',
                                 'scheduled_trip_time_2': 'category',
                                 'scheduled_departure_2': 'category',
                                 'scheduled_arrival_2': 'category',
                                 'day_of_week_2': 'category',
                                 'day_of_year_2': 'category',
                                 'taxi_out_2': 'category',
                                 'taxi_in_2': 'category',
                                 'wheels_off_2': 'category',
                                 'wheels_on_2': 'category',
                                 'year_2': 'category',
                                 'month_2': 'category',
                                 'elapsed_time_2': 'category',
                                 'air_time_2': 'category',
                                 'distance_2': 'category',
                                 'air_system_delay_2': 'category',
                                 'security_delay_2': 'category',
                                 'airline_delay_2': 'category',
                                 'late_aircraft_delay_2': 'category',
                                 'weather_delay_2': 'category'
                             }
                             )
            self.data.append(df)
...
def create_datasets_repository():
    ...
    datasets_path = path.join(par_dir, 'wide_flights/raw_datasets')
...
def create_wide_flights_env_properties():
    env_dataset_prop = EnvDatasetProp(
        ...
        DONT_FILTER_FIELDS,
        snorkel_data_obj=SnorkelWideFlightsDataObj,
        snorkel_gen_model=SnorkelGenModel,
        snorkel_training_path="snorkel_dataset_wide_flights.jsonl",
    )
