...
from gym_atena.data_schemas.wide12_flights.columns_data import (KEYS, KEYS_ANALYST_STR, FILTER_COLS, GROUP_COLS,
...
def create_datasets_repository():
    ...
    datasets_path = path.join(par_dir, 'wide12_flights/raw_datasets')
...
def create_wide12_flights_env_properties():
    env_dataset_prop = EnvDatasetProp(
        ...
        DONT_FILTER_FIELDS,
        snorkel_data_obj=SnorkelWide12FlightsDataObj,
        snorkel_gen_model=SnorkelGenModel,
        snorkel_training_path="snorkel_dataset_wide12_flights.jsonl",
    )
